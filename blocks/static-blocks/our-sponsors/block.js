...
(function (wpI18n, wpBlocks, wpElement, wpEditor, wpComponents) {
    ...
    >
      <g>
        <g>
          <path
            fill="#DF0A1E"
            d="M146.221,54.552l-7.549-6.523c-0.936-0.81-2.352-0.706-3.161,0.231c-0.81,0.937-0.706,2.352,0.23,3.162
      ...
      <g>
        <g>
          <path
            fill="#DF0A1E"
            d="M132.932,43.067L98.015,12.891c-2.21-1.91-5.03-2.843-7.942-2.632c-2.913,0.212-5.568,1.546-7.479,3.755
      ...
      <g>
        <g>
          <path
            fill="#DF0A1E"
            d="M111.65,35.142L51.244,14.881c-5.716-1.917-11.925,1.173-13.842,6.889l-0.797,2.376
      ...
      <g>
        <g>
          <path
            fill="#DF0A1E"
            d="M74.647,29.522H10.933C4.905,29.522,0,34.426,0,40.455v88.383c0,6.027,4.905,10.933,10.933,10.933h63.714
      ...
      <g>
        <g>
          <path
            fill="#DF0A1E"
            d="M75.814,91.395H9.767c-1.238,0-2.242,1.004-2.242,2.242s1.004,2.241,2.242,2.241h66.048
      ...
      <g>
        <g>
          <path
            fill="#DF0A1E"
            d="M65.363,104.215h-27.76c-1.238,0-2.242,1.003-2.242,2.241s1.004,2.241,2.242,2.241h27.76
      ...
      <g>
        <g>
          <path
            fill="#DF0A1E"
            d="M30.13,104.215h-9.914c-1.238,0-2.242,1.003-2.242,2.241s1.004,2.241,2.242,2.241h9.914
      ...
      <g>
        <g>
          <path
            fill="#DF0A1E"
            d="M65.363,112.783H20.217c-1.238,0-2.242,1.004-2.242,2.242s1.004,2.242,2.242,2.242h45.146
      ...
      <g>
        <g>
          <path
            fill="#DF0A1E"
            d="M65.363,121.354H20.217c-1.238,0-2.242,1.004-2.242,2.242c0,1.237,1.004,2.241,2.242,2.241h45.146
      ...
      <g>
        <g>
          <path
            fill="#DF0A1E"
            d="M67.429,55.533c-0.264-0.812-0.965-1.403-1.81-1.525l-14.386-2.09L44.8,38.881
  ...
  const osInsertMedaitoSlide = (sourceURL, attributes) => {
  ...
  class ourSponsorSlider extends Component {
    constructor() {
      super(...arguments);
      this.state = {
        currentSelected: 0,
    ...
    componentDidUpdate(prevProps) {
      ...
      const { attributes } = this.props;
      const { media, autoplay, dots, arrows, speed, slidesToShowDesktop,adaptiveHeight,centerMode,fade
        ,autoplaySpeed
      } =
        attributes;
    ...
    initSlider() {
      const { clientId } = this.props;  
      const { autoplay, dots,autoplaySpeed, slidesToShowDesktop, speed,adaptiveHeight,centerMode,fade} =
        this.props.attributes;
      const sliderObj = jQuery(`#block-${clientId} .md_essential_our_sponsor`).slick({
        infinite: true,
        slidesToScroll: 1,
        dots: dots,
        autoplay: autoplay,
    ...
    moveMedia(currentIndex, newIndex) {
      ...
      setAttributes({
        media: [
          ...media
            .filter((img, idx) => idx !== currentIndex)
            .slice(0, newIndex),
          currentMedia,
      ...
      if (0 === media.length) {
        return (
          <Placeholder
            ...
            instructions={__(
              "No media selected. Adding media to start using this block."
            )}
          >
            <MediaUpload
              value={null}
        ...
        <Fragment>
          <InspectorControls>
              ...
              <ToggleControl
                label="Dots"
                checked={dots}
                onChange={(newValue) => setAttributes({ dots: newValue })}
              />
              <ToggleControl
                label="Arrows"
                checked={arrows}
                onChange={(newValue) => setAttributes({ arrows: newValue })}
              />
              <ToggleControl
                label="Animation Fade"
                checked={fade}
                onChange={(newValue) => setAttributes({ fade: newValue }) }
              />
              {!fade?
              <ToggleControl
                label="Center Mode"
                checked={centerMode}
                onChange={(newValue) => setAttributes({ centerMode: newValue }) }
              />
              :
              ""}
              <div class="md_essential_our_sponsor-setting-tooltip">
                  <label>
                    Slide speed
                  <span class="dashicons dashicons-info"></span>
                  </label>
                  <span class="md_essential_our_sponsor-setting-tooltiptext">
                    Settings to control the speed of slides.                                </span>
              </div> 
              <TextControl
                type="text"
                value={speed}
                onChange={(newNumber) => setAttributes({ speed: newNumber })}
              />
              {
                autoplay ? 
                <div>
                  ...
                  <span class="md_essential_our_sponsor-setting-tooltiptext">
                    Settings to control the auto speed of slides.                                </span>
                </div> 
                <TextControl
                  type="text"
                  value={autoplaySpeed}
                  onChange={(newNumber) => setAttributes({ autoplaySpeed: newNumber })}
                />
                </div>
                :""
              }
              ...
              <span>
                <div class="md_essential_our_sponsor-setting-tooltip">
                    ...
                    <span class="md_essential_our_sponsor-setting-tooltiptext">
                      Settings to control the number of slides to show on desktop.                                </span>
                </div> 
                <RangeControl
                  min="1"
                  value={slidesToShowDesktop}
                  onChange={(newNumber) =>
                    newNumber !== "0" && newNumber ? setAttributes({ slidesToShowDesktop: newNumber }) : setAttributes({ slidesToShowDesktop: 1 })
                  }
                />
                <div class="md_essential_our_sponsor-setting-tooltip">
                    <label>
                    ...
                    <span class="md_essential_our_sponsor-setting-tooltiptext">
                      Settings to control the number of slides to show on Tablet.                                </span>
                </div>               
                <RangeControl
                  min="1"
                  value={slidesToShowTablet}
                  onChange={(newNumber) =>
                    newNumber !== "0" && newNumber ? setAttributes({ slidesToShowTablet: newNumber }) : setAttributes({ slidesToShowTablet: 1 })
                  }
                />
                <div class="md_essential_our_sponsor-setting-tooltip">
                    <label>
                    ...
                    <span class="md_essential_our_sponsor-setting-tooltiptext">
                      Settings to control the number of slides to show on mobile.                                </span>
                </div>               
                <RangeControl
                  min="1"
                  value={slidesToShowMobile}
                  onChange={(newNumber) =>
                      newNumber !== "0" && newNumber ? setAttributes({ slidesToShowMobile: newNumber }) : setAttributes({ slidesToShowMobile: 1 })
                  }
                />
                </span>
              :""  
          ...
          <div className={`md_essential_our_sponsor_block slider-arrow-main`}>
            <div
            ...
            >
              {media.map((source, index) => (
                <div className={"md_essential_our_sponsor-item"} key={index}>
                  ...
                  <span
                    ...
                    onClick={() => {
                      ...
                      let mediaItem = media.filter((img, idx) => idx !== index);
                      setAttributes({
                        media: mediaItem,
                      });
                    }}
            ...
            {isSelected && (
              <div className="md_essential_our_sponsor-add-item">
                <MediaUpload
                  ...
                  onSelect={(items) => {
                    ...
                    setAttributes({
                      media: [
                        ...media,
                        ...items.map((item) => pick(item, "id", "url", "alt")),
                      ],
                    });
                  }}
                  render={({ open }) => (
