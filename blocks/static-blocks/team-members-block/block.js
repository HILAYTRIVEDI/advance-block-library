			...
			<Fragment>
				<InspectorControls>
					...
					<PanelBody title="Text color settings" initialOpen={false}>
						<div className="setting-row">
							<label>Title/Heading Color</label>
							<span
								className="component-color-indicator"
								style={{ background: maintitleColor }}
							></span>
							<ColorPalette
								value={maintitleColor}
								onChange={(maintitleColor) => {
									setAttributes({
										maintitleColor: maintitleColor ? maintitleColor : "#fff",
									});
								}}
								colors={colors}
							/>
						...
						<div className="row">
							<div className={"col-12 fig-caption"}>
								<RichText
									...
									className="team-presenters-section__maintitle"
